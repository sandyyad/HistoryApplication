...
import Application from './Components/HistoryApplication'
import './App.css'
...
class App extends Component {
  ...
  deleteApp = id => {
    ...
    const deleteList = appDetails.filter(eachItem => eachItem.id !== id)
    this.setState({appDetails: deleteList})
  }
  ...
  render() {
    ...
    const searchResults = appDetails.filter(eachApp =>
    ...
    return (
      <div>
        ...
        <div>
          <ul>
            {searchResults.map(eachApplication => (
              <Application
